module.exports = {
  ...
  settings: {
    ...
    security: {
      title: "Zabezpečení",
      warning:
        "Pokud povolíš přístupovou frázi, bude vyžadována při každém otevření aplikace Satpile. Dávej pozor, protože neexistuje žádný způsob, jak ji obnovit.",
      ...
      create_passphrase:
        "Vytvoř přístupovou frázi, kterou budeš používat pro přístup k aplikaci Satpile.",
  ...
  permission: {
    camera:
      "Přístup ke kameře je zakázán. Chceš-li naskenovat QR kód, povol přístup k fotoaparátu v Nastavení > Satpile.",
    notification:
      "Aby fungovalo obnovování na pozadí, je třeba povolit oznámení.",
  },
  ...
  info_xpub:
    "Můžeš přidat XPUB peněženky (xpub/ypub/zpub) a automaticky sledovat její odvozené adresy.",
