module.exports = {
  ...
  scan_seedqr: "Scanner le SeedQR",
  generate_seed: "Generer une nouvelle seed",
  import_seed: "Importer une seed existante",
  cancel: "Annuler",
  done: "Valider",
  invalid_address: "Addresse non valide",
  invalid_seed: "Seed non valide",
  ...
  settings: {
    ...
    security: {
      title: "Sécurité",
      warning:
        "Lorsque la passphrase est activée, vous devez la saisir à chaque ouverture de Satpile. Attention, vous ne pouvez pas la récuperer en cas d'oubli.",
      ...
      create_passphrase:
        "Créez la passphrase que vous utiliserez pour accéder à Satpile",
  ...
  permission: {
    camera:
      "L'accès à la Camera est désactivé. Pour scanner des QRCode, merci d'autoriser la caméra dans Paramètres > Satpile.",
    notification:
      "Vous devez autoriser les notifications pour que le rafraichissement en arrière plan fonctionne.",
  },
  ...
  selected_starting_derivation_path:
    "Chemin de dérivation de départ selectionné :",
  generated_derivation_paths: "Chemins de dérivation suivants générés :",
  generate_new_addresses: "Générer de nouvelles adresses",
  info_xpub:
    "Vous pouvez ajouter une adresse XPUB (xpub/ypub/zpub) et automatiquement suive ses adresses dérivées.",
