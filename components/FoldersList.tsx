    ...
    return <SwipeList
        ...
        render={row => <>
            ...
            <ReorderButtons
                ...
                onClickDown={() => onSort(folders[row.index], folders[row.index+1])}
        ...
        ]} refreshing={refreshing} onRefresh={() => refresh()} showClose={false} showPreview={true} disableSwipe={showEditSort}/>
}
