...
const statusToColor = (status: TorStatusType) => {
  ...
  switch (status) {
    case TorStatusType.CONNECTED:
      return theme.colors.success;
    case TorStatusType.CONNECTING:
      return theme.colors.disabled;
    case TorStatusType.DISCONNECTED:
        ...
        setShow((show) => {
          if (show && Platform.OS === "ios") {
            LayoutAnimation.configureNext(
              LayoutAnimation.create(200, LayoutAnimation.Types.easeInEaseOut)
            );
          }
