...
export interface ActionRenameFolder
  extends BaseAction<ActionType.RENAME_FOLDER> {
  folder: Folder;
  newName: string;
}

export interface ActionRenameAddress
  extends BaseAction<ActionType.RENAME_ADDRESS> {
  folder: Folder;
  address: FolderAddress;
  newName: string;
}

export interface ActionRemoveFolder
  extends BaseAction<ActionType.REMOVE_FOLDER> {
  folder: Folder;
}

export interface ActionUpdateFolderTotal
  extends BaseAction<ActionType.UPDATE_FOLDERS_TOTAL> {
...
export interface ActionRemoveAddress
  extends BaseAction<ActionType.REMOVE_ADDRESS> {
  folder: Folder;
  address: FolderAddress;
}
...
export interface ActionSwapFolderAddresses
  extends BaseAction<ActionType.SWAP_FOLDER_ADDRESSES> {
  folder: Folder;
...
export interface ActionSortFolderAddresses
  extends BaseAction<ActionType.SORT_FOLDER_ADDRESSES> {
  folderOrder: ListOrderType;
  folder: Folder;
}

export interface ActionUpdateSettings
  extends BaseAction<ActionType.UPDATE_SETTINGS> {
  settings: Partial<Settings>;
}

export interface ActionUpdateAddress
  extends BaseAction<ActionType.UPDATE_ADDRESSES> {
  addresses: AddressesList;
}

export interface ActionUpdateSingleAddress
  extends BaseAction<ActionType.UPDATE_SINGLE_ADDRESS> {
  address: string;
  addressContent: AddressValue;
}

export interface ActionUpdateLastReloadTime
  extends BaseAction<ActionType.UPDATE_LAST_RELOAD_TIME> {}

export interface ActionAddDerivedAddresses
  extends BaseAction<ActionType.ADD_DERIVED_ADDRESSES> {
